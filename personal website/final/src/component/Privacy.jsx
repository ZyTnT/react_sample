import privacyPicture from '../picture/privacy.jpg'
...
function Privacy(props){
    return(
        <>
        <h1 style={{textAlign: 'center'}}>Website Privacy Statement</h1>
        <p>The Yutong Studio (“studio,” “we,” or “us”) cares about your privacy and wants you to be familiar with how we collect, use, and disclose data. This Privacy Statement covers the collection, use, and disclosure of data collected via nielsen.com and any other Nielsen website where this Privacy Statement is posted or linked (collectively, this “Site”). This Privacy Statement also describes your legal rights in relation to such data. </p>
        ...
        <ul>
            ...
            <li>
            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Yutong Studio.</p>
            </li>
            <li>
            ...
            <li>
            <p><strong>Website</strong> refers to Yutong Studio, accessible from <a href="www.yutongstudio.com" rel="external nofollow noopener" target="_blank">www.yutongstudio.com</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By phone number: 2066668451</li>
        </ul>
        </>
    )
}
